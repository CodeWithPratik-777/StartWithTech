...
const send2FAOTPEmail = async (email, otp) => {
  ...
  const mailOptions = {
    from: '"StartWithTech Support" <no-reply@startwithtech.com>',
    to: email,
    subject: 'Your One-Time Password (OTP) for Secure Login - StartWithTech',
    html: `
                    ...
                    <table align="center" width="570" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                      <tr>
                        <td style="padding: 35px;">
                          <h1 style="color: #292E31; font-size: 20px; margin-bottom: 10px;">Your 2FA OTP Code</h1>
                          <p style="font-size: 16px; color: #333;">To complete your login, use the following One-Time Password (OTP):</p>
                          <p style="font-size: 24px; font-weight: bold; color: #fa5005; margin: 20px 0;">${otp}</p>
                          <p style="font-size: 15px; color: #555; line-height: 1.6;">
                            This OTP is valid for <strong>5 minutes</strong>. If you didn’t request this, you can ignore this email.
                          </p>
                        </td>
                      </tr>
                    </table>
...
module.exports = send2FAOTPEmail;
