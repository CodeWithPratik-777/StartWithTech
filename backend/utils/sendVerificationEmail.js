...
const sendVerificationEmail = async (email, token) => {
  const action_url = `${process.env.BACKEND_URL}/api/auth/verify/${token}`;

  await transporter.sendMail({
    from: `"StartWithTech" <${process.env.EMAIL_USER}>`,
    to: email,
                      ...
                      <table align="center" width="570" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                        <tr>
                          <td style="padding: 35px;">
                            ...
                            <p style="font-size: 16px; color: #333;">Thanks for signing up for StartWithTech! Click the button below to verify your email address.</p>
